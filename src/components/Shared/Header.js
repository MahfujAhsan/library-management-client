    ...
    return (
        <div className='flex justify-between items-center lg:container mx-auto px-2 lg:px-12 py-4'>
            <div className=''>
                ...
                <h1 className='text-center font-semibold uppercase text-xs lg:text-4xl flex-grow font-mono px-2 lg:px-0'><span className='text-yellow-600'>🅻🅸🅱🆁🅰🆁🆈</span> <span className='text-pink-500'>🅼🅰🅽🅰🅶🅴🅼🅴🅽🆃</span></h1>
            <div className='flex justify-end gap-x-4'>
                {/* Responsive Menu */}
                {!user ? <Link className='lg:hidden border border-accent px-1 w-8 rounded-md bg-slate-600 hover:bg-transparent hover:text-white shadow-lg font-bold text-white flex items-center gap-x-2' to="/signup"><GoVerified size="large"/></Link> : <Link className='lg:hidden border-none w-8 rounded-md bg-slate-600 hover:bg-transparent hover:text-white shadow-lg font-bold text-white flex items-center gap-x-2' to="/profile"><HiUserCircle size="large"/></Link>}
